...
static const char *fonts[]          = { "azukifontLB:size=15" };
...
/*    "sh", "-c", "xrandr --output HDMI-0 --mode 1920x1080 --rate 74.97", NULL,
 "sh", "-c", "xrandr --output HDMI-0 --rotate left --left-of HDMI-1 --pos 1080x1500", NULL,*/
    "sh", "-c", "feh --bg-fill /home/kerojam/Pictures/wallpapers/normal/2025-02-15_01.44.43.png", NULL,
    NULL /*termintate*/
};
...
static const Key keys[] = {
	...
	{ MODKEY|ShiftMask,		XK_e,	   spawn, SHCMD("feh --bg-fill ~/Pictures/wallpapers/anime/BLIY/1265356.jpg")},
	{ MODKEY|ShiftMask|ControlMask,	XK_e,	   spawn, SHCMD("feh --bg-fill ~/Pictures/wallpapers/anime/BLIY/1178779.jpg")},
	{ MODKEY|ShiftMask|Mod1Mask,	XK_e,	   spawn,	SHCMD("feh --bg-fill ~/Pictures/wallpapers/anime/normal/GKe-Pc3aoAAt-A1.jpg")},
	{ MODKEY|ControlMask,		XK_e,	   spawn,	SHCMD("feh --bg-fill ~/Pictures/wallpapers/anime/BlueArchive/wallhaven-rdv5q7.jpg")},
	{ MODKEY|Mod1Mask,		XK_e,	   spawn,	SHCMD("feh --bg-fill ~/Pictures/wallpapers/normal/2025-02-15_01.44.43.png")},
